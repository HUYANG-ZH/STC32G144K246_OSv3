...
#define APP_ELEMENT_ROUNDABOUT_1_BIAS_DPS_DEFAULT (-520.0f)
#define APP_ELEMENT_ROUNDABOUT_2_BIAS_DPS_DEFAULT (900.0f)
#define APP_ELEMENT_ROUNDABOUT_3_BIAS_DPS_DEFAULT (-520.0f)
#define APP_ELEMENT_ROUNDABOUT_4_BIAS_DPS_DEFAULT (900.0f)
