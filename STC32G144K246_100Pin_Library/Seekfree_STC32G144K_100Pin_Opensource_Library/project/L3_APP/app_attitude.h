...
#define APP_ATTITUDE_KALMAN_Q_ANGLE_DEFAULT   (0.003f)
#endif

#ifndef APP_ATTITUDE_KALMAN_Q_BIAS_DEFAULT
#define APP_ATTITUDE_KALMAN_Q_BIAS_DEFAULT    (0.01f)
#endif

#ifndef APP_ATTITUDE_KALMAN_R_MEASURE_DEFAULT
#define APP_ATTITUDE_KALMAN_R_MEASURE_DEFAULT (0.02f)
#endif
...
/* pitch Kalman 测量噪声: 与 roll 的 R_MEASURE 保持一致(car2 标定值) */
#ifndef APP_ATTITUDE_PITCH_KALMAN_R_DEFAULT
#define APP_ATTITUDE_PITCH_KALMAN_R_DEFAULT   (0.02f)
#endif
