...
uint16 app_inductor_preprocess_min_value[APP_INDUCTOR_CHANNEL_COUNT] = {650U, 850U, 550U, 650U, 100U};
uint16 app_inductor_preprocess_max_value[APP_INDUCTOR_CHANNEL_COUNT] = {4095U, 2850U, 2950U, 4095U, 4095U};
