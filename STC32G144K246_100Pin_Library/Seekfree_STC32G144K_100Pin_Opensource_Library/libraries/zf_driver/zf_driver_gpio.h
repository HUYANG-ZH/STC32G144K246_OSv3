...
typedef enum
{
    ...
    IO_P80 = 0x90, IO_P81, IO_P82, IO_P83, IO_P84, IO_P85, IO_P86, IO_P87,
    IO_P90 = 0xA0, IO_P91, IO_P92, IO_P93, IO_P94, IO_P95, IO_P96, IO_P97,
    IO_PA0 = 0xB0, IO_PA1, IO_PA2, IO_PA3, IO_PA4, IO_PA5, IO_PA6, IO_PA7,
    IO_PB0 = 0xC0, IO_PB1, IO_PB2, IO_PB3, IO_PB4, IO_PB5, IO_PB6, IO_PB7,
    IO_PC0 = 0xD0, IO_PC1, IO_PC2, IO_PC3, IO_PC4, IO_PC5, IO_PC6, IO_PC7,
...
typedef enum
{
    GPIO_DRIVE_ENHANCE = 0,  		// 增强驱动能力
    GPIO_DRIVE_NORMOL  = 1,  		// 一般驱动能力
}gpio_drive_capability_enum;

typedef enum
{
    GPIO_SPEED_LOW  = 1,  	// 电平转换速度慢，相应的上下冲比较小
    GPIO_SPEED_FAST = 0,  	// 电平转换速度快，相应的上下冲比较大

}gpio_speed_enum;

typedef enum
{
    GPIO_DIGITAL_IN_DISABLE = 0,  	// 数字信号使能
    GPIO_DIGITAL_IN_ENABLE  = 1,  	// 数字信号失能
}gpio_port_digital_signal_input_enum;
